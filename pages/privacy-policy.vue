<template>
  <div class="container px-4">
    ...
    <div class="word_wrap">
      ...
      <div>
        <p>
          This privacy notice for 13756700 Canada Inc. (doing business as MockCertified)
          ("MockCertified," "we," "us," or "our"), describes how and why we might collect, store,
        ...
        <p>
          <span>Questions or concerns?</span> Reading this privacy notice will help you understand
          ...
          contact us at mockcertified@gmail.com.
        </p>
      </div>
      ...
      <div>
        ...
        <p class="fw-bolder">
          ...
          click
          <a href="#1">here</a> to go directly to our table of contents.
        </p>

        <p>
          <span>What personal information do we process?</span> When you visit, use, or navigate our
          Services, we may process personal information depending on how you interact with
          MockCertified and the Services, the choices you make, and the products and features you
          use. Click <a href="#2">here</a> to learn more.
        </p>

        <p>
          <span>Do we process any sensitive personal information?</span> We do not process sensitive
        ...
        <p>
          <span>How do we process your information? </span> We process your information to provide,
          ...
          reason to do so. Click <a href="#3">here</a> to learn more.
        </p>

        <p>
          <span>In what situations and with which parties do we share personal information?</span>
          We may share information in specific situations and with specific third parties. Click
          <a href="#4">here</a> to learn more.
        </p>

        <p>
          <span> How do we keep your information safe?</span> We have organizational and technical
          ...
          <a href="#5">here</a> to learn more.
        </p>

        <p>
          <span>What are your rights?</span> Depending on where you are located geographically, the
          applicable privacy law may mean you have certain rights regarding your personal
          information. Click <a href="#6">here</a> to learn more.
        </p>
        ...
        <p>
          ...
          <a href="#1">here</a> to review the notice in full.
        </p>
      </div>

      <div>
        <h2 id="1">TABLE OF CONTENTS</h2>
        <p>
          <a href="#20"> 1. WHAT INFORMATION DO WE COLLECT?</a> <br />
          <a href="#3"> 2. HOW DO WE PROCESS YOUR INFORMATION?</a> <br />
          <a href="#19"> 3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</a>
          <br />
          <a href="#4"> 4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a> <br />
          <a href="#18"> 5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a> <br />
          <a href="#7"> 6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</a> <br />
          <a href="#17"> 7. HOW LONG DO WE KEEP YOUR INFORMATION?</a> <br />
          <a href="#5"> 8. HOW DO WE KEEP YOUR INFORMATION SAFE?</a> <br />
          <a href="#16"> 9. DO WE COLLECT INFORMATION FROM MINORS?</a> <br />
          <a href="#6"> 10. WHAT ARE YOUR PRIVACY RIGHTS?</a> <br />
          ...
          <a href="#13"> 13. DO WE MAKE UPDATES TO THIS NOTICE?</a> <br />
          <a href="#14"> 14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a> <br />
          <a href="#15"> 15. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a>
        </p>
        <br />
      </div>

      <div>
        <h2 id="20">1. WHAT INFORMATION DO WE COLLECT?</h2>

        <p class="fw-bolder" id="2">Personal information you disclose to us</p>
        ...
        <p>
          <span>Personal Information Provided by You.</span> The personal information that we
        ...
        <p>
          <span>Payment Data.</span> We may collect data necessary to process your payment if you
        ...
        <p>
          <span>Social Media Login Data.</span> We may provide you with the option to register with
          ...
          <a href="#7">"HOW DO WE HANDLE YOUR SOCIAL LOGINS?"</a> below.
        </p>

        <p>
          <span>Application Data.</span> If you use our application(s), we also may collect the
          following information if you choose to provide us with access or permission:
        </p>

        <ul>
          <li>
            <span>Push Notifications.</span> We may request to send you push notifications regarding
      ...
      <div>
        ...
        <p>
          <span>In Short:</span> Some information — such as your Internet Protocol (IP) address
        ...
        <ul>
          <li>
            <span>Log and Usage Data.</span> Log and usage data is service-related, diagnostic,
          ...
          <li>
            <span>Device Data.</span> We collect device data such as information about your
          ...
          <li>
            <span>Location Data.</span> We collect location data such as information about your
      ...
      <div>
        <h2 id="3">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
        <p>
          <span>In Short:</span> We process your information to provide, improve, and administer our
        ...
        <ul>
          ...
          <li>
            <span>To deliver and facilitate delivery of services to the user.</span> We may process
            your information to provide you with the requested service.
          </li>
          <li>
            <span>To respond to user inquiries/offer support to users.</span> We may process your
            information to respond to your inquiries and solve any potential issues you might have
            with the requested service.
          </li>
          <li>
            <span>To send administrative information to you.</span> We may process your information
            to send you details about our products and services, changes to our terms and policies,
            and other similar information.
          </li>
          <li>
            <span>To fulfill and manage your orders.</span> We may process your information to
            fulfill and manage your orders, payments, returns, and exchanges made through the
            Services.
          </li>
          <li>
            <span>To enable user-to-user communications.</span> We may process your information if
            you choose to use any of our offerings that allow for communication with another user.
          </li>
          <li>
      ...
      <div>
        <h2 id="19">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h2>

        <p>
          <span>In Short:</span> We only process your personal information when we believe it is
          necessary and we have a valid legal reason (i.e., legal basis) to do so under applicable
          law, like with your consent, to comply with laws, to provide you with services to enter
          into or fulfill our contractual obligations, to protect your rights, or to fulfill our
          legitimate business interests.
        </p>

        <p class="fw-bolder">If you are located in the EU or UK, this section applies to you.</p>
        ...
        <ul>
          <li>
            <span>Consent.</span> We may process your information if you have given us permission
            (i.e., consent) to use your personal information for a specific purpose. You can
            withdraw your consent at any time. Click <a href="#8">here</a> to learn more.
          </li>
          <li>
          ...
          <li>
            <span>Vital Interests.</span> We may process your information where we believe it is
        ...
        <p class="fw-bolder">If you are located in Canada, this section applies to you.</p>
        ...
        <p>
          ...
          any time. Click <a href="#8">here</a> to learn more.
        </p>
      ...
      <div>
        ...
        <p>
          <span>In Short:</span> We may share information in specific situations described in this
        ...
        <ul>
          <li>
            <span>Business Transfers. </span> We may share or transfer your information in
            connection with, or during negotiations of, any merger, sale of company assets,
            financing, or acquisition of all or a portion of our business to another company.
          </li>
          <li>
            <span>When we use Google Maps Platform APIs.</span> We may share your information with
            certain Google Maps Platform APIs (e.g., Google Maps API, Places API). To find out more
            about Google’s Privacy Policy, please refer to this link.
          </li>
        </ul>
      </div>

      <div>
        <h2 id="18">5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>

        <p>
          <span>In Short:</span> We may use cookies and other tracking technologies to collect and
      ...
      <div>
        <h2 id="7">6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>

        <p>
          <span>In Short:</span> If you choose to register or log in to our services using a social
      ...
      <div>
        <h2 id="17">7. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
        <p>
          <span>In Short:</span> We keep your information for as long as necessary to fulfill the
        ...
        <p>
          ...
          months past the start of the idle period of the user's account.
        </p>
        <p>
      ...
      <div>
        <h2 id="5">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
        <p>
          <span>In Short:</span> We aim to protect your personal information through a system of
      ...
      <div>
        <h2 id="16">9. DO WE COLLECT INFORMATION FROM MINORS?</h2>

        <p>
          <span>In Short:</span> We do not knowingly collect data from or market to children under
          18 years of age.
        </p>
        ...
        <p>
          ...
          under age 18, please contact us at mockcertified@gmail.com.
        </p>
      </div>

      <div>
        <h2 id="6">10. WHAT ARE YOUR PRIVACY RIGHTS?</h2>

        <p>
          <span>In Short:</span> In some regions, such as the European Economic Area (EEA), United
        ...
        <p>
          ...
          of your personal information, (ii) to request rectification or erasure; (iii) to restrict
          ...
          <a href="#9">"HOW CAN YOU CONTACT US ABOUT THIS NOTICE?"</a> below.
        </p>
        ...
        <p id="8">
          <span>Withdrawing your consent:</span> If we are relying on your consent to process your
          ...
          section <a href="#9"> "HOW CAN YOU CONTACT US ABOUT THIS NOTICE?"</a> below.
        </p>
        ...
        <p>
          <span>Opting out of marketing and promotional communications:</span> You can unsubscribe
          ...
          <a href="#9">"HOW CAN YOU CONTACT US ABOUT THIS NOTICE?"</a> below. You will then be
      ...
      <div>
        ...
        <p>
          <span>Cookies and similar technologies</span>: Most Web browsers are set to accept cookies
      ...
      <div>
        <h2 id="12">12. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>

        <p>
          <span>In Short:</span> Yes, if you are a resident of California, you are granted specific
      ...
      <div>
        <h2 id="13">13. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
        <p>
          <span>In Short:</span> Yes, we will update this notice as necessary to stay compliant with
          relevant laws.
        </p>
        <p>
      ...
      <div>
        <h2 id="#14">14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>

        <p>
          If you have questions or comments about this notice, you may email us at
          mockcertified@gmail.com or by post to:
        </p>

        <p>
          13756700 Canada Inc. <br />
          31 Tippett Rd, North York, ON M3H 0C8, Canada <br />
          Toronto, Ontario M3H 0C8 <br />
          Canada
        </p>
      </div>

      <div>
        <h2 id="15">15. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
