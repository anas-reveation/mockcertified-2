<template>
  <div class="container px-4">
    ...
    <div>
      ...
      <a href="#4">4. PROHIBITED ACTIVITIES</a> <br />
      <a href="#5">5. USER GENERATED CONTRIBUTIONS</a> <br />
      <a href="#6">6. CONTRIBUTION LICENSE</a> <br />
      <a href="#7">7. GUIDELINES FOR REVIEWS</a> <br />
      <a href="#8">8. MOBILE APPLICATION LICENSE </a> <br />
      <a href="#9">9. SUBMISSIONS</a> <br />
      <a href="#10">10. THIRD-PARTY WEBSITE AND CONTENT</a> <br />
      <a href="#11">11. SITE MANAGEMENT</a> <br />
      <a href="#12">12. PRIVACY POLICY</a> <br />
      <a href="#13">13. COPYRIGHT INFRINGEMENTS</a> <br />
      <a href="#14">14. TERM AND TERMINATION</a> <br />
      <a href="#15">15. MODIFICATIONS AND INTERRUPTIONS</a> <br />
      <a href="#16">16. GOVERNING LAW</a> <br />
      <a href="#17">17. DISPUTE RESOLUTION</a> <br />
      <a href="#18">18. CORRECTIONS</a> <br />
      <a href="#19">19. DISCLAIMER</a> <br />
      <a href="#20">20. LIMITATIONS OF LIABILITY</a> <br />
      <a href="#21">21. INDEMNIFICATION</a> <br />
      <a href="#22">22. USER DATA</a> <br />
      <a href="#23">23. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a> <br />
      <a href="#24">24. CALIFORNIA USERS AND RESIDENTS</a> <br />
      <a href="#25">25. MISCELLANEOUS</a> <br />
      <a href="#26">26. CONTACT US</a> <br />
      <br /> -->
      ...
      <div>
        ...
        <p>
          ...
          personally or on behalf of an entity (“you”) and mc ("Company," “we," “us," or “our”),
          concerning your access to and use of the fm.com website as well as any other media form,
          media channel, mobile website or mobile application related, linked, or otherwise
          connected thereto (collectively, the “Site”). We are registered in Canada and have our
          registered office at 31 tippet rd, North York, Ontario M3H 0C8. You agree that by
      ...
      <div>
        ...
        <p>
          ...
          agree to comply with these Terms of Use; (2) you are not a minor in the jurisdiction in
          which you reside; (3) you will not access the Site through automated or non-human means,
          whether through a bot, script, or otherwise; (4) you will not use the Site for any illegal
          or unauthorized purpose; and (5) your use of the Site will not violate any applicable law
          or regulation.
        </p>
      ...
      <div>
        ...
        <p>
          ...
          works, such Contributions, and grant and authorize sublicenses of the foregoing. The use
      ...
      <div>
        ...
        <p class="fw-bolder">Use License</p>
        <p>
          ...
          this mobile application license contained in these Terms of Use. You shall not: (1) except
          as permitted by applicable law, decompile, reverse engineer, disassemble, attempt to
          derive the source code of, or decrypt the application; (2) make any modification,
          adaptation, improvement, enhancement, translation, or derivative work from the
          application; (3) violate any applicable laws, rules, or regulations in connection with
          your access or use of the application; (4) remove, alter, or obscure any proprietary
          notice (including any notice of copyright or trademark) posted by us or the licensors of
          the application; (5) use the application for any revenue generating endeavor, commercial
          enterprise, or other purpose for which it is not designed or intended; (6) make the
          application available over a network or other environment permitting access or use by
          multiple devices or users at the same time; (7) use the application for creating a
        ...
        <p class="fw-bolder">Apple and Android Devices</p>

        <p>
          The following terms apply when you use a mobile application obtained from either the Apple
          Store or Google Play (each an “App Distributor”) to access the Site: (1) the license
          ...
          the mobile application; (3) in the event of any failure of the mobile application to
          conform to any applicable warranty, you may notify the applicable App Distributor, and the
          App Distributor, in accordance with its terms and policies, may refund the purchase price,
          if any, paid for the mobile application, and to the maximum extent permitted by applicable
          law, the App Distributor will have no other warranty obligation whatsoever with respect to
          the mobile application; (4) you represent and warrant that (i) you are not located in a
          country that is subject to a U.S. government embargo, or that has been designated by the
          U.S. government as a “terrorist supporting” country and (ii) you are not listed on any
          U.S. government list of prohibited or restricted parties; (5) you must comply with
      ...
      <div>
        ...
        <p>
          ...
          of any website to which you navigate from the Site or relating to any applications you use
          or install from the Site. Any purchases you make through Third-Party Websites will be
          through other websites and from other companies, and we take no responsibility whatsoever
          in relation to such purchases which are exclusively between you and the applicable third
      ...
      <div>
        ...
        <p>
          ...
          PARTICIPATION IN THE SITE OR DELETE ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY
      ...
      <div>
        ...
        <p>
          These Terms shall be governed by and defined following the laws of Canada. mc and yourself
          irrevocably consent that the courts of Canada shall have exclusive jurisdiction to resolve
      ...
      <div>
        ...
        <p class="fw-bolder">Binding Arbitration</p>
        ...
        <p>
          ...
          toronto, Canada. The language of the proceedings shall be English. The governing law of
          the contract shall be the substantive law of Canada.
        </p>

        <p class="fw-bolder">Restrictions</p>
        ...
        <p class="fw-bolder">Exceptions to Arbitration</p>
      ...
      <div>
        ...
        <p>
          ...
          (6) any overt harmful act toward any other user of the Site with whom you connected via
          the Site. Notwithstanding the foregoing, we reserve the right, at your expense, to assume
      ...
      <div>
        ...
        <p>
          We possess zero liability for any sort of loss or misinformation as most of the
          questionnaires/tests are from third party sellers. Please do your due diligence before
          buying.
        </p>
      </div>
      ...
      <div>
        ...
        <p class="fw-bolder">
          mc <br />
          31 tippet rd <br />
          North York, Ontario M3H 0C8 <br />
          Canada <br />
          Phone: 252526987 <br />
          deepak.batech@gmail.com
        </p>
      </div>
      <!--  -->
    </div>
