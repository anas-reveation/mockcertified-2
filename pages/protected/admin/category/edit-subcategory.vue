<template>
  <div class="container container_width">
    <h1 class="mt-5 mb-4 font_size_32 col-md-12">Update Subcategory</h1>
...
export default {
  ...
  head() {
    return {
      title: `Update Mock Test Subcategory - ${this.formData.name}`,
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: `Update your ${this.formData.name} subcategory by entering a new subcategory name and image URL.`,
        },
        {
          hid: 'og:title',
          property: 'og:title',
          content: `Update Mock Test Subcategory - ${this.formData.name} - Mockcertified App`,
        },
        {
          hid: 'og:description',
        ...
        {
          name: 'keywords',
          content: 'Update Mocktest Subcategory, Mockcertified App',
        },
        {
          hid: 'og:type',
          property: 'og:type',
