<template>
  <div class="text-left">
    ...
    <div class="d-flex flex-column mt-2">
      <ul class="list-group">
        <li
          ...
          :key="index2"
          class="list-group-item border border-2 border-primary rounded text-break text-dark mb-2 test_option"
          :class="
    ...
    <div>
      ...
      <div v-if="question.explainantion" class="text-break test_question">
