    ...
    <div class="background_color">
      <div class="container px-5">
        <div class="row align-items-center justify-content-between">
          <div class="col-12 col-md-5 col-lg-12 text-center pt-5 mt-5 pt-md-0 mt-md-0">
            <form class="wrapper width_res font-size-16" @submit.prevent="loginLocal">
              <div class="my-3 input-data">
                <p class="fw-bolder font-size-14 text-start mb-2">Email</p>
                <input
                  type="text"
                  class="border border-2 border-grey rounded py-1 px-3"
              ...
              <div class="mb-2 input-data">
                <p class="fw-bolder font-size-14 text-start mb-2">Password</p>
              ...
              <div class="text-start">
                <NuxtLink
                  ...
                  class="text-decoration-none text-primary font_size_14 auth_font_size font_family_nunito"
                >
                  Forgot Password?
                </NuxtLink>
              </div>
              ...
              <div class="text-center mt-3">
                <button
                  type="submit"
                  class="btn text-white fw-bold px-5 w-100"
              ...
              <div>
                ...
                <div class="social_icons pb-5">
                  ...
                  <p class="font-size-14 font_family_popping_light my-3">
                    New to Mockcertified? <span class="text-primary">Sign up</span>
                  </p>
                </div>
              </div>
            </form>
